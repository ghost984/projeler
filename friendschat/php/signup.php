            ...
            if(mysqli_num_rows($sql) > 0) // if email already exist
            {
               echo "$email - This email already exist!"; 
                ...
                if(isset($_FILES['image'])) // if file is uploaded
                {
                    ...
                    $tpm_name = $_FILES['image']['tmp_name']; // this temporary name is used to save/move file in our folder
                    ...
                    if(in_array( $img_ext, $extensions) === true) // if user uploaded img ext is matched with any array extensions
                    {
                       ...
                       if( move_uploaded_file($tpm_name, "images/".$new_image_name )) // if user upload img move to our folder successfully
                      {
                        ...
                        if($sql2) // if these data İnserted
                        {
